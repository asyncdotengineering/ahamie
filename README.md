...
Read the v0 plan in [`SPEC.md`](./SPEC.md). Documentation: [`apps/docs`](./apps/docs).
...
The full docs site lives in [`apps/docs`](./apps/docs) (Astro + Starlight, Diataxis-discipline):
