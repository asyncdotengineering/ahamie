...
- Drizzle schema: [`packages/storage/src/schema/`](https://github.com/asyncdotengineering/ahamie/tree/main/packages/storage/src/schema)
- SQL migration: [`packages/storage/drizzle/0000_init.sql`](https://github.com/asyncdotengineering/ahamie/blob/main/packages/storage/drizzle/0000_init.sql)
