...
| **Live docs** | https://ahamie-docs.vercel.app (Astro + Starlight, Diataxis-discipline, 29 pages) |
...
| **Vercel project** | `octalpixels-projects/ahamie-docs` (auto-deploys from `main`) |
